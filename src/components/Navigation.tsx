    ...
    <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 pointer-events-auto">
      <motion.div 
        ...
        style={{
          ...
          boxShadow: '0 20px 50px -10px rgba(0,0,0,1), inset 0 1px 1px rgba(255,255,255,0.1)',
        }}
      >
          ...
          return (
            <button
              ...
              className={`relative z-10 flex items-center gap-2 px-3 sm:px-5 py-2 rounded-full text-[12px] sm:text-[13px] font-medium transition-colors focus:outline-none ${
                isActive ? 'text-white shadow-[0_2px_10px_rgba(0,0,0,0.5)]' : 'text-zinc-400 hover:text-zinc-200 hover:bg-white/5'
              }`}
            >
              {isActive && (
                <motion.div
