  ...
  return (
    <div className="absolute inset-0 overflow-hidden mix-blend-screen blur-[4px]">
        ...
        <motion.div
           ...
           transition={{ duration: isActive ? 3 : 10, repeat: Infinity, ease: "linear" }}
        >
            {/* Blue Orb */}
            <motion.div 
               ...
               transition={{ duration: isHovered ? 0.8 : 2, repeat: isHovered ? 0 : Infinity, ease: "easeInOut" }}
            />
            {/* Purple Orb */}
            <motion.div 
               ...
               transition={{ duration: isHovered ? 0.8 : 2.5, repeat: isHovered ? 0 : Infinity, ease: "easeInOut" }}
            />
            {/* Orange/Pink Orb */}
            <motion.div 
               ...
               transition={{ duration: isHovered ? 0.8 : 3, repeat: isHovered ? 0 : Infinity, ease: "easeInOut" }}
            />
            ...
            <motion.div 
               ...
               transition={{ duration: isHovered ? 0.8 : 2.2, repeat: isHovered ? 0 : Infinity, ease: "easeInOut" }}
            />
        </motion.div>
    </div>
  );
