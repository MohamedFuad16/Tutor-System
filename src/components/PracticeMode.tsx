      ...
      <div className="max-w-[800px] w-full mx-auto pb-32">
        <div className="mb-6">
          ...
          <p className="text-[var(--color-text-secondary)] mt-1.5 text-sm">
            Solve coding challenges based on prior concepts to solidify your
            understanding.
          </p>
        </div>
        ...
        <div className="p-6 rounded-[24px] bg-[var(--color-canvas-elevated)] border border-[var(--color-border-subtle)] shadow-[var(--shadow-elevation-low)] mt-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-[15px] font-medium text-[var(--color-text-primary)]">
              Challenge: Implement a Context Provider
            </h3>
            <span className="ml-auto px-2 py-0.5 rounded-full bg-[#1A1C23] text-[var(--color-text-secondary)] text-[10px] font-mono uppercase border border-[var(--color-border-subtle)]">
              React Fundamentals
            </span>
          </div>

          <p className="text-[14px] text-[var(--color-text-secondary)] leading-relaxed mb-6">
            Create a `ThemeProvider` component that uses React Context to
            provide a `theme` string ("light" or "dark") and a `toggleTheme`
          ...
          <div className="w-full rounded-[12px] bg-[#0F0F10] border border-[var(--color-border-strong)] flex flex-col overflow-hidden font-mono text-[13px]">
            ...
            <div
              className="p-4 text-[#ECECEC] whitespace-pre-wrap outline-none"
              contentEditable
