/**
 * WGSL for the liquid glass orb. Ported from LerSent001/orb
 * (https://github.com/LerSent001/orb, MIT, commit 8d1736e). effect.wgsl is
 * vendored verbatim; this file adds the full-screen vertex stage and the
 * fragment entry points, unchanged from the upstream shader-source.ts.
 */
