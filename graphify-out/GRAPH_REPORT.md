...
Cohesion: 0.04
Nodes (44): BetaBrainFlowLedgerInput, BetaBrainFlowSignal, BetaBrainFlowSignalEvidence, BetaDiagnosticItem, BetaDiagnosticOverallStatus, BetaDiagnosticsExportInput, BetaDiagnosticsInput, BetaDiagnosticsSnapshot (+36 more)
...
Cohesion: 0.22
Nodes (15): buildProviderCapture(), hasModelObservationGate(), isChatLayer(), isChatThreadPersistence(), isSeededEvidenceSource(), isSyntheticEvidenceSource(), isVoiceLayer(), isVoiceThreadPersistence() (+7 more)
...
Cohesion: 0.5
Nodes (4): hasRequestId(), isMultiPdfContextInjection(), metadataArrayLength(), metadataNumber()
