...
## Corpus Check
- 131 files · ~191,084 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1328 nodes · 2504 edges · 125 communities (89 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dd1f08fc`
...
9. `applyCorrectionPropagation()` - 12 edges
10. `UsageAnalyticsStrip()` - 11 edges
...
Cohesion: 0.07
Nodes (57): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+49 more)
...
Cohesion: 0.10
Nodes (41): BRAIN_RUNTIME_SETTING_LIMITS, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy(), WEB_SEARCH_POLICIES, BetaDiagnosticItem (+33 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (74): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PatternCard(), PdfViewer(), formatCount(), formatCurrency() (+66 more)
...
Cohesion: 0.05
Nodes (50): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, ArtifactRecord, BookChatThread, BrainDatabase, CitationState (+42 more)
...
## Knowledge Gaps
- **485 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+480 more)
...
- **Why does `db` connect `Community 13` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 14`, `Community 23`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 4` to `Community 1`, `Community 10`, `Community 3`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 3` to `Community 1`, `Community 10`, `Community 4`?**
