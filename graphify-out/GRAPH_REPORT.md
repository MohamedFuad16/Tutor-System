...
## Corpus Check
- 95 files · ~164,544 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1052 nodes · 1857 edges · 62 communities (50 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb048545`
...
Cohesion: 0.09
Nodes (25): BetaBrainFlowLedgerInput, BetaBrainFlowSignal, BetaBrainFlowSignalEvidence, BetaDiagnosticItem, BetaDiagnosticOverallStatus, BetaDiagnosticsExportInput, BetaDiagnosticsInput, BetaDiagnosticsSnapshot (+17 more)
...
Cohesion: 0.06
Nodes (53): recordGeneratedNotesArtifact(), BackgroundJobEventInput, backgroundJobIdFor(), BackgroundJobRunResult, BackgroundJobStatusInput, compact(), createBackgroundJobRecord(), errorSummary() (+45 more)
...
Cohesion: 0.05
Nodes (59): BASE_CHAT_AGENT_TOOL_DEFINITIONS, buildChatAgentToolDefinitions(), ChatAgentToolDefinition, chatAgentToolNames(), CURRENT_PAGE_CHAT_AGENT_TOOL_DEFINITION, buildTutorInteractionContext(), countWords(), createTutorInteractionSnapshot() (+51 more)
...
Cohesion: 0.1
Nodes (19): blockedFlow, chatMultiPdfSignal, chatOnlyMemoryFlow, checklist, completeBrainFlow, coverage, emptyFlow, flowItem (+11 more)
...
Cohesion: 0.2
Nodes (11): buildBetaDiagnosticsSnapshot(), buildBrainFlowCoverageFromLedgers(), buildSignalEvidence(), compactUnique(), item(), mergeSignalEvidence(), numberOrZero(), requiredCounts() (+3 more)
...
## Knowledge Gaps
- **368 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+363 more)
...
- **Why does `db` connect `Community 60` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 23`, `Community 57`, `Community 59`?**
