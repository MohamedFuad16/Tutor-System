...
## Corpus Check
- 95 files · ~157,454 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 932 nodes · 1674 edges · 73 communities (47 shown, 26 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1eced9a2`
...
Cohesion: 0.08
Nodes (27): debugAdminToken, debugTokenFromRequest(), DEEPGRAM_PRICING, deepgramKeyFromRequest(), fetchOpenRouterPricing(), firstHeader(), getOpenRouterServerFallbackKey(), hostNameFromHeader() (+19 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (23): BKTEngine, DEFAULT_BKT, CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase (+15 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (50): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PatternCard(), PdfViewer(), SettingsButton(), SiriLiquidGlass() (+42 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (33): clamp01(), confidenceFromModelSummary(), confidenceFromUnderstandingDelta(), gateModelSummaryMastery(), isVerifiedMasteryEvidence(), MasteryEvidenceType, masteryFromEvidenceAttempt(), TYPE_CAPS (+25 more)
...
Cohesion: 0.10
Nodes (34): pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), userBrainArchitectureBook, Flashcard, AppDesignLanguagePage() (+26 more)
...
Cohesion: 0.17
Nodes (12): createTutorServerApp(), startServer(), createTutorServerApp(), startServer(), config, getTutorApp(), normalizeVercelCatchAllUrl(), vercelHandler() (+4 more)

### Community 26 - "Community 26"
Cohesion: 0.09
Nodes (21): Accepted Results, brain architecture implementation program: phase 1 report, brain architecture implementation program: phase 2 report, Conflicts Resolved, Final Report: brain architecture implementation program, Graphify Context, Graphify Context, Integration Decisions (+13 more)
...
## Knowledge Gaps
- **338 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+333 more)
...
- **Why does `vercelHandler()` connect `Community 25` to `Community 2`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `useStore` connect `Community 2` to `Community 4`, `Community 5`, `Community 6`, `Community 15`?**
