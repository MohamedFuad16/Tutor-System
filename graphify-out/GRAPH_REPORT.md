...
## Corpus Check
- 77 files · ~132,777 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 733 nodes · 1293 edges · 50 communities (40 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7a07c52d`
...
Cohesion: 0.05
Nodes (30): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BrainDatabase (+22 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (40): recordGeneratedNotesArtifact(), compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput, ModelSummaryEvidenceInput, recordMasteryDelta() (+32 more)
...
Cohesion: 0.04
Nodes (32): AnimatedMarkdown, ChatArchive, codeFileName(), codeLanguageLabel(), gsapMotion, InteractiveCodeBlock, languageExtensions, languageLabels (+24 more)
...
Cohesion: 0.07
Nodes (16): userBrainArchitectureBook, BuiltInBook, builtInBookIds, builtInBooks, designTokens, FlashcardUI, LibraryDeleteTarget, MermaidApi (+8 more)
...
Cohesion: 0.18
Nodes (5): LearningBook, brainOrchestrator, CardTarget, documentObjectUrlCache, StudyIntroSplashProps
...
- **Why does `db` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 10`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 22`, `Community 26`, `Community 30`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 21` to `Community 2`, `Community 10`, `Community 7`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 21` to `Community 2`, `Community 10`, `Community 7`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
