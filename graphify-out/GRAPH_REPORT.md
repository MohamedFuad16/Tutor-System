...
## Corpus Check
- 77 files · ~132,198 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 730 nodes · 1280 edges · 43 communities (33 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d28e4742`
...
6. `compact()` - 12 edges
7. `createArtifactRecord()` - 12 edges
8. `applyCorrectionPropagation()` - 10 edges
9. `createRetrievalEventRecord()` - 10 edges
10. `UsageAnalyticsStrip()` - 10 edges
...
Cohesion: 0.06
Nodes (48): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+40 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (36): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, db, LearningChapter (+28 more)
...
Cohesion: 0.04
Nodes (30): AnimatedMarkdown, ChatArchive, codeFileName(), codeLanguageLabel(), gsapMotion, InteractiveCodeBlock, languageExtensions, languageLabels (+22 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (30): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PdfViewer(), SettingsButton(), SiriLiquidGlass(), useMotionPreference() (+22 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (29): PatternCard(), pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), userBrainArchitectureBook, compact() (+21 more)

### Community 6 - "Community 6"
Cohesion: 0.13
Nodes (39): applyArtifactCitationState(), applyCitationIntegrityResult(), artifactRecordIdFor(), ArtifactStatusInput, ArtifactVerificationInput, artifactVerificationStateForCitationStates(), CitationIntegrityResult, CitationIntegrityState (+31 more)
...
Cohesion: 0.12
Nodes (16): CitationState, ActivityStatus, AdminRequestTimeline, AdminTab, AdminView(), correctionImpactedRows(), correctionPropagationFor(), formatTime() (+8 more)

### Community 12 - "Community 12"
Cohesion: 0.15
Nodes (11): createTutorServerApp(), startServer(), config, getTutorApp(), normalizeVercelCatchAllUrl(), vercelHandler(), form, startApp() (+3 more)
...
## Knowledge Gaps
- **225 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+220 more)
...
- **Why does `db` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 16`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 21` to `Community 9`, `Community 2`, `Community 11`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 21` to `Community 9`, `Community 2`, `Community 11`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
