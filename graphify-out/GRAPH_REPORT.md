...
## Corpus Check
- 87 files · ~146,522 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 891 nodes · 1535 edges · 57 communities (45 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fda9aa76`
...
Cohesion: 0.08
Nodes (30): clamp01(), confidenceFromModelSummary(), confidenceFromUnderstandingDelta(), gateModelSummaryMastery(), MasteryEvidenceType, TYPE_CAPS, VERIFIED_MASTERY_EVIDENCE, ConversationInteraction (+22 more)
...
Cohesion: 0.1
Nodes (35): addRows(), addTarget(), applyCorrectionPropagation(), buildCorrectionPropagationMetadata(), buildCorrectionPropagationPatch(), cleanList(), collectCorrectionPropagationTargets(), compact() (+27 more)
...
Cohesion: 0.11
Nodes (17): recordStoredAudioOverviewArtifacts(), ActivityStatus, AdminRequestTimeline, AdminTab, artifactTypeBuckets, correctionImpactedRows(), correctionPropagationFor(), isLocallyVerifiableArtifactType() (+9 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (43): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, CognitiveLoadMonitor, CognitiveLoadState, compactSummary(), createLedgerId(), createMasteryDeltaRecords() (+35 more)
...
Cohesion: 0.4
Nodes (6): buildBetaDiagnosticsSnapshot(), buildBrainFlowCoverageFromLedgers(), item(), AdminView(), formatTime(), statusTone()
...
## Knowledge Gaps
- **304 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+299 more)
...
- **Why does `db` connect `Community 12` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 11`, `Community 21`, `Community 23`, `Community 24`, `Community 27`, `Community 28`, `Community 30`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `createTutorServerApp()` connect `Community 8` to `Community 2`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `useStore` connect `Community 21` to `Community 1`, `Community 33`, `Community 4`, `Community 39`, `Community 9`, `Community 11`, `Community 15`, `Community 18`, `Community 20`?**
