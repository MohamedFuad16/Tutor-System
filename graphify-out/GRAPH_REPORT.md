...
## Corpus Check
- 100 files · ~179,509 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1171 nodes · 2027 edges · 67 communities (56 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `476fe654`
...
Cohesion: 0.05
Nodes (38): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, ArtifactRecord, BookChatThread, BrainDatabase, db (+30 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (56): recordStoredAudioOverviewArtifacts(), addRows(), addTarget(), applyCorrectionPropagation(), buildConceptCorrectionPatch(), buildCorrectionPropagationMetadata(), buildCorrectionPropagationPatch(), cleanList() (+48 more)
...
Cohesion: 0.08
Nodes (15): compactBrainContextMetadata(), compactStringList(), debugAdminToken, DEEPGRAM_PRICING, fetchOpenRouterPricing(), nonNegativeInteger(), normalizeModelPricing(), objectMetadata() (+7 more)
...
## Knowledge Gaps
- **440 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+435 more)
...
- **Why does `db` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 36`, `Community 7`, `Community 8`, `Community 16`, `Community 17`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `createTutorServerApp()` connect `Community 11` to `Community 12`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `useStore` connect `Community 17` to `Community 3`, `Community 4`, `Community 7`, `Community 39`, `Community 13`, `Community 22`, `Community 28`, `Community 30`?**
