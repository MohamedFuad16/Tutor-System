...
## Corpus Check
- 121 files · ~180,528 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1192 nodes · 2222 edges · 109 communities (73 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ece6d635`
...
Cohesion: 0.05
Nodes (43): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, ConversationInteraction, db (+35 more)

### Community 3 - "Community 3"
Cohesion: 0.08
Nodes (46): LearningBook, LearningDocument, MemoryEvent, RetrievalEvent, cosineSimilarity(), fnv1a(), generateEmbedding(), initEmbeddings() (+38 more)
...
Cohesion: 0.12
Nodes (35): BRAIN_RUNTIME_SETTING_LIMITS, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy(), WEB_SEARCH_POLICIES, cleanList() (+27 more)
...
Cohesion: 0.16
Nodes (24): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+16 more)
...
## Knowledge Gaps
- **433 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+428 more)
...
- **Why does `db` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 12`, `Community 13`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 0` to `Community 8`, `Community 1`, `Community 5`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 5` to `Community 8`, `Community 1`, `Community 0`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
