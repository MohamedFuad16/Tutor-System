...
## Corpus Check
- 56 files · ~108,180 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 489 nodes · 786 edges · 30 communities (21 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e67f65b2`
...
Cohesion: 0.05
Nodes (48): createTutorServerApp(), debugAdminToken, debugTokenFromRequest(), DEEPGRAM_PRICING, deepgramKeyFromRequest(), fetchOpenRouterPricing(), firstHeader(), getOpenRouterServerFallbackKey() (+40 more)
...
Cohesion: 0.08
Nodes (28): clamp01(), confidenceFromModelSummary(), confidenceFromUnderstandingDelta(), gateModelSummaryMastery(), MasteryEvidenceType, TYPE_CAPS, VERIFIED_MASTERY_EVIDENCE, ConversationInteraction (+20 more)
...
## Knowledge Gaps
- **148 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+143 more)
...
- **Why does `useStore` connect `Community 2` to `Community 4`, `Community 5`, `Community 6`, `Community 10`, `Community 15`?**
