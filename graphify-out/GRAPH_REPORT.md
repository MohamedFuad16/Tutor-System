...
## Corpus Check
- 97 files · ~178,314 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1152 nodes · 2008 edges · 72 communities (59 shown, 13 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f91b44ae`
...
Cohesion: 0.05
Nodes (37): pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), audioOverviewEntries, builtInBookAudioOverviews, ChapterAudioOverview (+29 more)
...
Cohesion: 0.11
Nodes (27): BKTAttemptOptions, BKTEngine, buildBKTConfidenceUpdate(), DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord() (+19 more)
...
Cohesion: 0.19
Nodes (11): ChatPanel(), PdfViewer(), Language, translations, useTranslation(), brainOrchestrator, useStore, CardTarget (+3 more)
...
Cohesion: 0.15
Nodes (11): BackgroundJob, BookChatThread, BrainDatabase, CitationState, ConversationInteraction, CorrectionEvent, LearningChapter, LearningEntry (+3 more)
...
Cohesion: 0.26
Nodes (8): FloatingSkillsMenu(), SKILLS, Navigation(), PatternCard(), SiriLiquidGlass(), useMotionPreference(), ViewState, RevisionView()
...
## Knowledge Gaps
- **434 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+429 more)
...
- **Why does `db` connect `Community 22` to `Community 1`, `Community 2`, `Community 3`, `Community 36`, `Community 5`, `Community 6`, `Community 39`, `Community 8`, `Community 7`, `Community 11`, `Community 12`, `Community 16`, `Community 24`, `Community 25`, `Community 29`, `Community 30`, `Community 31`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `MisconceptionGraph` connect `Community 43` to `Community 25`, `Community 22`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `createTutorServerApp()` connect `Community 13` to `Community 0`?**
