...
## Corpus Check
- 142 files · ~194,697 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1461 nodes · 2742 edges · 144 communities (109 shown, 35 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bdcaf6a7`
...
7. `compact()` - 15 edges
8. `createArtifactRecord()` - 15 edges
9. `scripts` - 14 edges
...
Cohesion: 0.07
Nodes (56): recordGeneratedNotesArtifact(), compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput, ModelSummaryEvidenceInput, recordMasteryDelta() (+48 more)
...
Cohesion: 0.14
Nodes (47): applyArtifactCitationState(), applyCitationIntegrityResult(), artifactRecordIdFor(), ArtifactStatusInput, ArtifactVerificationInput, artifactVerificationStateForCitationStates(), CitationIntegrityResult, CitationIntegrityState (+39 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (68): BetaDiagnosticItem, BetaDiagnosticOverallStatus, BetaDiagnosticsExportInput, BetaDiagnosticsInput, BetaDiagnosticsSnapshot, BetaDiagnosticStatus, buildBetaDiagnosticsExport(), buildBetaDiagnosticsSnapshot() (+60 more)
...
Cohesion: 0.13
Nodes (15): createTutorServerApp(), startServer(), createTutorServerApp(), startServer(), config, getTutorApp(), normalizeVercelCatchAllUrl(), vercelHandler() (+7 more)
...
Cohesion: 0.19
Nodes (8): BookChatThread, BrainDatabase, LearningChapter, LearningEntry, Misconception, SessionMemoryRecord, TraceLog, MisconceptionGraph
...
Cohesion: 0.44
Nodes (7): BRAIN_RUNTIME_SETTING_LIMITS, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy(), WEB_SEARCH_POLICIES
...
## Knowledge Gaps
- **558 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+553 more)
...
- **Why does `db` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 18`, `Community 19`, `Community 22`, `Community 25`, `Community 29`, `Community 31`?**
