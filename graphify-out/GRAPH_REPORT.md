...
## Corpus Check
- 137 files · ~197,671 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1411 nodes · 2667 edges · 132 communities (97 shown, 35 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c6c27456`
...
7. `scripts` - 14 edges
8. `compact()` - 14 edges
9. `createArtifactRecord()` - 14 edges
...
Cohesion: 0.05
Nodes (51): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, db, LearningChapter (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (72): recordGeneratedNotesArtifact(), BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord() (+64 more)
...
Cohesion: 0.07
Nodes (69): BetaDiagnosticItem, BetaDiagnosticOverallStatus, BetaDiagnosticsExportInput, BetaDiagnosticsInput, BetaDiagnosticsSnapshot, BetaDiagnosticStatus, buildBetaDiagnosticsExport(), buildBetaDiagnosticsSnapshot() (+61 more)

### Community 6 - "Community 6"
Cohesion: 0.08
Nodes (41): pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), userBrainArchitectureBook, Flashcard, compact() (+33 more)
...
## Knowledge Gaps
- **530 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+525 more)
...
- **Why does `db` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 7` to `Community 9`, `Community 2`, `Community 5`, `Community 21`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 21` to `Community 9`, `Community 2`, `Community 5`, `Community 7`?**
