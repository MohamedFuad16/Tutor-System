...
## Corpus Check
- 106 files · ~167,190 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1029 nodes · 1899 edges · 82 communities (50 shown, 32 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5487f477`
...
Cohesion: 0.06
Nodes (43): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BrainDatabase, db, EvidenceEvent, LearningChapter (+35 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (75): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PdfViewer(), formatCount(), formatCurrency(), planCardMeta (+67 more)
...
Cohesion: 0.04
Nodes (45): Accepted Results, brain architecture implementation program: phase 1 report, brain architecture implementation program: phase 2 report, brain architecture implementation program: phase 3 report, brain architecture implementation program: phase 4 report, brain architecture implementation program: phase 5 report, brain architecture implementation program: phase 6 report, Conflicts Resolved (+37 more)
...
## Knowledge Gaps
- **371 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+366 more)
...
- **Why does `App()` connect `Community 3` to `Community 1`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `vercelHandler()` connect `Community 1` to `Community 3`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `useStore` connect `Community 3` to `Community 17`, `Community 2`, `Community 4`, `Community 5`?**
