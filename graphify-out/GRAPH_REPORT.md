...
## Corpus Check
- 95 files · ~168,867 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1076 nodes · 1900 edges · 70 communities (56 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af2540b4`
...
Cohesion: 0.07
Nodes (30): BetaBrainFlowLedgerInput, BetaBrainFlowSignal, BetaBrainFlowSignalEvidence, BetaDiagnosticItem, BetaDiagnosticOverallStatus, BetaDiagnosticsExportInput, BetaDiagnosticsInput, BetaDiagnosticsSnapshot (+22 more)
...
Cohesion: 0.07
Nodes (25): aggregateFlow, blockedFlow, chatMultiPdfSignal, chatOnlyMemoryFlow, checklist, coherentProof, completeBrainFlow, completeBrainFlowLedgers (+17 more)
...
Cohesion: 0.27
Nodes (10): buildBetaDiagnosticsSnapshot(), buildBrainFlowCoverageFromLedgers(), buildCoherentLiveProofFromLedgers(), buildSignalEvidence(), item(), latestTimestampFromAnchors(), mergeAnchors(), AdminView() (+2 more)
...
Cohesion: 0.29
Nodes (7): buildLiveBetaProofRunbook(), buildProviderKeyProofChecklist(), compactUnique(), emptySignalEvidence(), mergeCheckEvidence(), mergeSignalEvidence(), sharedStrings()
...
## Knowledge Gaps
- **381 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+376 more)
...
- **Why does `db` connect `Community 2` to `Community 0`, `Community 1`, `Community 64`, `Community 65`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 19`, `Community 20`, `Community 57`, `Community 60`, `Community 61`, `Community 25`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `createTutorServerApp()` connect `Community 13` to `Community 4`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 62` to `Community 1`, `Community 4`, `Community 9`, `Community 15`?**
