...
## Corpus Check
- 76 files · ~134,114 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 688 nodes · 1158 edges · 47 communities (32 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 7 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1e5e2f35`
...
Cohesion: 0.06
Nodes (49): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+41 more)
...
Cohesion: 0.05
Nodes (28): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, db, LearningChapter (+20 more)
...
Cohesion: 0.13
Nodes (12): ArtifactRecord, CitationState, ActivityStatus, AdminTab, AdminView(), formatTime(), serverApiUrl(), serverBaseUrl() (+4 more)
...
Cohesion: 0.25
Nodes (14): cleanList(), compact(), CorrectionEventActionInput, correctionEventIdFor(), CorrectionEventInput, CorrectionEventStatusInput, CorrectionEventTargetInput, createCorrectionEventRecord() (+6 more)
...
Cohesion: 0.27
Nodes (9): normalizeBrainRuntimeSettings(), BRAIN_RUNTIME_SETTING_LIMITS, BrainRuntimeSettings, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy() (+1 more)
...
## Knowledge Gaps
- **222 isolated node(s):** `parsed`, `rows`, `seen`, `results`, `title` (+217 more)
...
- **Why does `db` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 8`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 21`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 17` to `Community 2`, `Community 12`, `Community 7`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 17` to `Community 2`, `Community 12`, `Community 7`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
