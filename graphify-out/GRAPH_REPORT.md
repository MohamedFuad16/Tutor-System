...
## Corpus Check
- 100 files · ~163,661 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 978 nodes · 1789 edges · 78 communities (48 shown, 30 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8f76966d`
...
Cohesion: 0.08
Nodes (43): BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput, ModelSummaryEvidenceInput (+35 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (28): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, ConversationInteraction, db (+20 more)
...
Cohesion: 0.06
Nodes (70): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PdfViewer(), formatCount(), formatCurrency(), planCardMeta (+62 more)
...
Cohesion: 0.06
Nodes (33): Accepted Results, brain architecture implementation program: phase 1 report, brain architecture implementation program: phase 2 report, brain architecture implementation program: phase 3 report, brain architecture implementation program: phase 4 report, Conflicts Resolved, Final Report: brain architecture implementation program, Graphify Context (+25 more)

### Community 6 - "Community 6"
Cohesion: 0.10
Nodes (34): PatternCard(), pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), userBrainArchitectureBook, AppDesignLanguagePage() (+26 more)
...
Cohesion: 0.06
Nodes (38): createTutorServerApp(), createTutorServerApp(), debugAdminToken, debugTokenFromRequest(), DEEPGRAM_PRICING, deepgramKeyFromRequest(), fetchOpenRouterPricing(), firstHeader() (+30 more)
...
## Knowledge Gaps
- **354 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+349 more)
...
- **Why does `vercelHandler()` connect `Community 11` to `Community 3`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `useStore` connect `Community 3` to `Community 16`, `Community 4`, `Community 6`, `Community 7`?**
