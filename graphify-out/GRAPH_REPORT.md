...
## Corpus Check
- 63 files · ~111,879 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 547 nodes · 905 edges · 33 communities (24 shown, 9 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9b4be747`
...
Cohesion: 0.07
Nodes (39): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+31 more)
...
Cohesion: 0.06
Nodes (22): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, ConversationInteraction, db (+14 more)
...
Cohesion: 0.06
Nodes (30): pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), userBrainArchitectureBook, compact(), flashcardEvidenceConceptId() (+22 more)
...
## Knowledge Gaps
- **168 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+163 more)
...
- **Why does `useStore` connect `Community 3` to `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 17`?**
