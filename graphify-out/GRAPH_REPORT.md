...
## Corpus Check
- 97 files · ~159,719 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 957 nodes · 1751 edges · 75 communities (47 shown, 28 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d19ffa06`
...
Cohesion: 0.06
Nodes (38): createTutorServerApp(), debugAdminToken, debugTokenFromRequest(), DEEPGRAM_PRICING, deepgramKeyFromRequest(), fetchOpenRouterPricing(), firstHeader(), getOpenRouterServerFallbackKey() (+30 more)

### Community 1 - "Community 1"
Cohesion: 0.10
Nodes (36): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PdfViewer(), SettingsButton(), SiriLiquidGlass(), useMotionPreference() (+28 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (37): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, db, EvidenceEvent (+29 more)
...
Cohesion: 0.08
Nodes (45): BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput, ModelSummaryEvidenceInput (+37 more)

### Community 6 - "Community 6"
Cohesion: 0.10
Nodes (35): PatternCard(), pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), userBrainArchitectureBook, Flashcard (+27 more)
...
Cohesion: 0.07
Nodes (27): Accepted Results, brain architecture implementation program: phase 1 report, brain architecture implementation program: phase 2 report, brain architecture implementation program: phase 3 report, Conflicts Resolved, Final Report: brain architecture implementation program, Graphify Context, Graphify Context (+19 more)
...
## Knowledge Gaps
- **346 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+341 more)
...
- **Why does `vercelHandler()` connect `Community 0` to `Community 1`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `useStore` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 17`?**
