...
## Corpus Check
- 133 files · ~194,252 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1366 nodes · 2593 edges · 126 communities (91 shown, 35 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b4121533`
...
9. `compact()` - 12 edges
10. `createArtifactRecord()` - 12 edges
...
Cohesion: 0.06
Nodes (71): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+63 more)
...
Cohesion: 0.40
Nodes (8): BRAIN_RUNTIME_SETTING_LIMITS, BrainRuntimeSettings, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy(), WEB_SEARCH_POLICIES
...
Cohesion: 0.13
Nodes (43): applyArtifactCitationState(), applyCitationIntegrityResult(), artifactRecordIdFor(), ArtifactStatusInput, ArtifactVerificationInput, artifactVerificationStateForCitationStates(), CitationIntegrityResult, CitationIntegrityState (+35 more)
...
Cohesion: 0.06
Nodes (73): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PatternCard(), PdfViewer(), formatCount(), formatCurrency() (+65 more)
...
Cohesion: 0.05
Nodes (50): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BrainDatabase, db, LearningChapter, LearningEntry (+42 more)
...
Cohesion: 0.43
Nodes (5): BookChatThread, ChatPhase, Message, MindMapLink, MindMapNode
...
## Knowledge Gaps
- **502 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+497 more)
...
- **Why does `db` connect `Community 11` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 2` to `Community 12`, `Community 5`, `Community 6`, `Community 7`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 2` to `Community 12`, `Community 5`, `Community 6`, `Community 7`?**
