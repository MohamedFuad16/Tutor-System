...
## Corpus Check
- 78 files · ~127,902 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1439 nodes · 2712 edges · 132 communities (98 shown, 34 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6cec271d`
...
Cohesion: 0.11
Nodes (37): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+29 more)
...
Cohesion: 0.1
Nodes (43): BRAIN_RUNTIME_SETTING_LIMITS, BrainRuntimeSettings, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy(), WEB_SEARCH_POLICIES (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (45): pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), ChapterAudioOverview, userBrainChapterAudioOverviews, userBrainArchitectureBook (+37 more)
...
Cohesion: 0.06
Nodes (59): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PatternCard(), PdfViewer(), SettingsButton(), SiriLiquidGlass() (+51 more)
...
Cohesion: 0.05
Nodes (46): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, ArtifactRecord, BookChatThread, BrainDatabase, CitationState (+38 more)
...
Cohesion: 0.12
Nodes (44): addRows(), addTarget(), applyCorrectionPropagation(), buildCorrectionPropagationMetadata(), buildCorrectionPropagationPatch(), cleanList(), collectCorrectionPropagationTargets(), compact() (+36 more)

### Community 19 - "Community 19"
Cohesion: 0.12
Nodes (36): formatCount(), formatCurrency(), planCardMeta, UsageGraphBar(), UsageInsightsPanel(), UserUsagePanel(), AccessMode, estimateServiceMinutes() (+28 more)
...
Cohesion: 0.33
Nodes (5): Graphify Context, Integration Decisions, Phase 18: Book Reader And Stored Audio Overview, Remaining Work, Verification Evidence
...
Cohesion: 0.4
Nodes (5): Graphify Context, Integration Decisions, Phase 17: Learning-note Artifact Provenance, Remaining Work, Verification Evidence
...
## Knowledge Gaps
- **544 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+539 more)
...
- **Why does `db` connect `Community 13` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 6`, `Community 7`, `Community 18`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 3` to `Community 9`, `Community 19`, `Community 5`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 3` to `Community 9`, `Community 19`, `Community 5`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
