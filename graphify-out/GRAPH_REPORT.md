...
## Corpus Check
- 90 files · ~148,533 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 918 nodes · 1587 edges · 54 communities (40 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `148b2c67`
...
Cohesion: 0.06
Nodes (45): gateModelSummaryMastery(), ConversationInteraction, cosineSimilarity(), generateEmbedding(), normalize(), TOKEN_STOPWORDS, tokenize(), clamp01() (+37 more)
...
Cohesion: 0.11
Nodes (48): applyArtifactCitationState(), applyCitationIntegrityResult(), artifactRecordIdFor(), ArtifactStatusInput, ArtifactVerificationInput, artifactVerificationStateForCitationStates(), CitationIntegrityResult, CitationIntegrityState (+40 more)

### Community 5 - "Community 5"
Cohesion: 0.09
Nodes (39): AnswerEvidenceEngine, AnswerEvidenceType, boundedText(), clamp01(), compact(), evaluatedAnswerConceptId(), EvaluatedAnswerEvidenceInput, EvaluatedAnswerEvidenceResult (+31 more)
...
Cohesion: 0.05
Nodes (50): BRAIN_RUNTIME_SETTING_LIMITS, BrainRuntimeSettings, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy(), WEB_SEARCH_POLICIES (+42 more)
...
## Knowledge Gaps
- **314 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+309 more)
...
- **Why does `db` connect `Community 20` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 12`, `Community 13`, `Community 16`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `createTutorServerApp()` connect `Community 10` to `Community 1`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `useStore` connect `Community 16` to `Community 0`, `Community 34`, `Community 3`, `Community 9`, `Community 12`, `Community 15`, `Community 19`, `Community 22`?**
