...
## Corpus Check
- 125 files · ~184,428 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1241 nodes · 2331 edges · 115 communities (79 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8629a5a1`
...
Cohesion: 0.07
Nodes (58): BKTAttemptOptions, BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput (+50 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (49): ChatPanel(), FloatingSkillsMenu(), SKILLS, Navigation(), PdfViewer(), formatCount(), formatCurrency(), planCardMeta (+41 more)
...
Cohesion: 0.06
Nodes (43): CognitiveLoadMonitor, CognitiveLoadState, chooseFlashcardConcept(), compact(), containsConceptPhrase(), createFlashcardForStorage(), ensurePersistentConceptForLearningBookConcept(), FlashcardConceptResolution (+35 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (41): PatternCard(), pressDots, themes, SvgBeige(), SvgDark(), SvgOrange(), userBrainArchitectureBook, compact() (+33 more)
...
Cohesion: 0.11
Nodes (35): BRAIN_RUNTIME_SETTING_LIMITS, BrainRuntimeSettings, BrainWebSearchPolicy, clampInteger(), DEFAULT_BRAIN_RUNTIME_SETTINGS, normalizeBrainRuntimeSettings(), normalizeWebSearchPolicy(), WEB_SEARCH_POLICIES (+27 more)
...
Cohesion: 0.25
Nodes (22): artifactRecordIdFor(), ArtifactStatusInput, ArtifactVerificationInput, citationStateIdFor(), CitationStateInput, cleanList(), compact(), createArtifactRecord() (+14 more)
...
Cohesion: 0.11
Nodes (41): cleanList(), compact(), CorrectionEventActionInput, correctionEventIdFor(), CorrectionEventInput, CorrectionEventStatusInput, CorrectionEventTargetInput, createCorrectionEventRecord() (+33 more)
...
## Knowledge Gaps
- **451 isolated node(s):** `parser`, `plugins`, `extends`, `version`, `browser` (+446 more)
...
- **Why does `db` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 10`, `Community 12`, `Community 48`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `BrainRuntimeSettings` connect `Community 7` to `Community 8`, `Community 2`, `Community 12`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `DEFAULT_BRAIN_RUNTIME_SETTINGS` connect `Community 7` to `Community 8`, `Community 2`, `Community 12`?**
...
- **Should `Community 1` be split into smaller, more focused modules?**
  _Cohesion score 0.0852359208523592 - nodes in this community are weakly interconnected._
