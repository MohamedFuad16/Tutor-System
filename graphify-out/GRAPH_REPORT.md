...
## Corpus Check
- 97 files · ~176,124 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1134 nodes · 1979 edges · 73 communities (61 shown, 12 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5cfd03f8`
...
Cohesion: 0.06
Nodes (52): BASE_CHAT_AGENT_TOOL_DEFINITIONS, buildChatAgentToolDefinitions(), ChatAgentToolDefinition, chatAgentToolNames(), CURRENT_PAGE_CHAT_AGENT_TOOL_DEFINITION, buildTutorInteractionContext(), countWords(), createTutorInteractionSnapshot() (+44 more)
...
Cohesion: 0.06
Nodes (36): BetaBrainFlowLedgerInput, BetaBrainFlowSignal, BetaBrainFlowSignalEvidence, BetaDiagnosticItem, BetaDiagnosticOverallStatus, BetaDiagnosticsExportInput, BetaDiagnosticsInput, BetaDiagnosticsSnapshot (+28 more)
...
Cohesion: 0.1
Nodes (25): chooseFlashcardConcept(), compact(), containsConceptPhrase(), createFlashcardForStorage(), ensurePersistentConceptForLearningBookConcept(), ensurePersistentConceptForLearningBookConceptId(), FlashcardConceptResolution, FlashcardStorageContext (+17 more)
...
Cohesion: 0.15
Nodes (11): ArtifactRecord, BackgroundJob, BookChatThread, BrainDatabase, CitationState, CorrectionEvent, LearningChapter, LearningEntry (+3 more)

### Community 29 - "Community 29"
Cohesion: 0.21
Nodes (13): buildProviderCapture(), hasModelObservationGate(), isChatLayer(), isChatThreadPersistence(), isVoiceLayer(), isVoiceThreadPersistence(), memoryEventBookId(), memoryEventConversationId() (+5 more)
...
Cohesion: 0.32
Nodes (8): buildLiveBetaProofDrillPacket(), buildLiveBetaProofReceipt(), buildLiveBetaProofRunbook(), buildProviderKeyProofChecklist(), compactUnique(), mergeCheckEvidence(), mergeSignalEvidence(), sharedStrings()
...
Cohesion: 0.33
Nodes (6): buildBetaDiagnosticsSnapshot(), buildBrainFlowCoverageFromLedgers(), buildSignalEvidence(), item(), numberOrZero(), requiredCounts()
...
## Knowledge Gaps
- **420 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+415 more)
...
- **Why does `db` connect `Community 19` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 37`, `Community 6`, `Community 8`, `Community 9`, `Community 40`, `Community 11`, `Community 12`, `Community 16`, `Community 23`, `Community 27`, `Community 28`, `Community 31`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `createTutorServerApp()` connect `Community 14` to `Community 10`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `MisconceptionGraph` connect `Community 46` to `Community 19`, `Community 28`?**
