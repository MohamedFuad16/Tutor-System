...
## Corpus Check
- 57 files · ~109,907 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 505 nodes · 828 edges · 32 communities (22 shown, 10 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b9c760da`
...
Cohesion: 0.06
Nodes (20): CognitiveLoadMonitor, CognitiveLoadState, IllusionDetector, LearnerModel, BookChatThread, BrainDatabase, db, Flashcard (+12 more)
...
Cohesion: 0.1
Nodes (21): gateModelSummaryMastery(), ConversationInteraction, LearningBookConcept, cosineSimilarity(), generateEmbedding(), normalize(), TOKEN_STOPWORDS, tokenize() (+13 more)
...
Cohesion: 0.15
Nodes (19): BKTEngine, DEFAULT_BKT, compactSummary(), createLedgerId(), createMasteryDeltaRecords(), createModelSummaryEvidenceRecord(), MasteryDeltaInput, ModelSummaryEvidenceInput (+11 more)
...
Cohesion: 0.13
Nodes (12): EvidenceEvent, MasteryDelta, ToolJob, ActivityStatus, AdminTab, AdminView(), formatTime(), serverApiUrl() (+4 more)
...
## Knowledge Gaps
- **151 isolated node(s):** `deferredPreloadChunks`, `DEEPGRAM_PRICING`, `OpenRouterPricing`, `RequestLike`, `debugAdminToken` (+146 more)
...
- **Why does `useStore` connect `Community 1` to `Community 3`, `Community 4`, `Community 6`, `Community 10`, `Community 17`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `App()` connect `Community 1` to `Community 12`?**
  _High betweenness centrality (0.189) - this node is a cross-community bridge._
- **Why does `vercelHandler()` connect `Community 12` to `Community 1`?**
