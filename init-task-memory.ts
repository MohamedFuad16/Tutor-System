...
const baseTask = {
  ...
  migrationNotes:
    "All future autonomous agents MUST read the /brain before touching code.",
  followupWork:
    "Integrate this into a pre-commit hook to auto-regenerate AST graphs.",
};

fs.writeFileSync(
  path.join(tasksDir, "task-memory.json"),
